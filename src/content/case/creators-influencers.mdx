...
seo:
  ...
  keywords: ["content creators", "influencers", "AI video", "YouTube", "TikTok", "Instagram", "content monetization", "channel growth"]
---
...
<FeatureGrid>
  <Feature title="Rapid Content Production" description="Create complete videos in minutes instead of hours" icon="speed" />
  <Feature title="Consistent Characters" description="LoRA technology preserves your character details across all videos" icon="users" />
  <Feature title="Multi-Platform Adaptation" description="One content in formats for TikTok, YouTube and Instagram without rework" icon="layout" />
</FeatureGrid>
...
<CTABox>
  **LIMITED TIME OFFER**: Get 5 free AI videos and a personal content strategy consultation — offer ends soon! [Start Now →](#)
</CTABox>
