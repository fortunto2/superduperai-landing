...
<FeatureGrid>
  <Feature
    ...
    description="Turn any script or prompt into a full video story fast."
    icon="clock"
  />
  <Feature
    title="No Skills Needed"
    description="AI handles editing, effects, and sound so you don't have to."
    icon="wand"
  />
  <Feature
    title="Consistent Characters"
    description="Keep your protagonists on‑brand across every episode."
    icon="users"
  />
  <Feature
    title="Multi‑Platform Output"
    description="Export perfect ratios for YouTube, TikTok, Instagram, and more."
    icon="layout"
  />
</FeatureGrid>
...
<CTABox>**Ready to create your first AI‑generated video story?**</CTABox>
