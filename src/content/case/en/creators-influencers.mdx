...
<FeatureGrid>
  <Feature
    ...
    description="Create complete videos in minutes instead of hours"
    icon="speed"
  />
  <Feature
    title="Consistent Characters"
    description="LoRA technology preserves your character details across all videos"
    icon="users"
  />
  <Feature
    title="Multi-Platform Adaptation"
    description="One content in formats for TikTok, YouTube and Instagram without rework"
    icon="layout"
  />
</FeatureGrid>
