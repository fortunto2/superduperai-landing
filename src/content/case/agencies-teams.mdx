...
seo:
  ...
  keywords: ["creative agency", "video production", "team collaboration", "client projects", "rapid prototyping"]
---
...
<FeatureGrid>
  <Feature title="Rapid Prototyping" description="Test concepts and create visual mockups in minutes instead of days" icon="layers" />
  <Feature title="Collaborative Workflow" description="Seamlessly share and iterate on projects across distributed teams" icon="users" />
  <Feature title="Client Presentation" description="Impress clients with quick turnaround of high-quality concepts" icon="presentation" />
</FeatureGrid>
...
<CTABox>
  Transform your agency's video production capabilities. Start creating faster, better content for your clients today!
</CTABox> 