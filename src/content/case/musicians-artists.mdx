...
seo:
  ...
  keywords: ["music videos", "independent musicians", "AI visuals", "music promotion", "artist tools"]
---
...
<FeatureGrid>
  <Feature title="Vibe-Based Visuals" description="Generate visuals that match the exact mood and atmosphere of your music" icon="music" />
  <Feature title="No Budget Limitations" description="Create professional music videos without expensive production costs" icon="dollar" />
  <Feature title="Artistic Control" description="Maintain creative direction while AI handles technical execution" icon="palette" />
</FeatureGrid>
...
<CTABox>
  Transform your music into visual experiences. Create your first AI music video today!
</CTABox> 