...
<FeatureGrid>
  <Feature title="Free Credits" description="1,000+ free generation credits for your creative projects" icon="sparkles" />
  <Feature title="1:1 Support" description="Direct assistance from our product team to maximize results" icon="users" />
  <Feature title="Early Access" description="Be first to try our newest features and AI models" icon="star" />
  <Feature title="Community" description="Join a network of forward-thinking creators" icon="share" />
</FeatureGrid>
...
<CTABox buttonHref="https://calendly.com/superduperai" buttonText="Schedule a Call with Our Team">
