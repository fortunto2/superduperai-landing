...
locale: "en"
seo:
  title: "Vibe Filmmaking: turn a mood into cinematic video art | SuperDuperAI"
  description: "Describe a mood, an aesthetic or drop a reference — the AI assembles cinematic video from it. No script, no timeline."
  keywords:
    - vibe filmmaking
    - AI video
    - mood-based video
