...
featured: true
seo:
  title: "Agent Director: an AI film crew you direct | SuperDuperAI"
  description: "You direct, the agents work: script, shots, edit and sound handled by a specialised AI crew. You approve each step."
  keywords:
    - AI director
    - AI production
    - multi-agent system
