...
seo:
  ...
  keywords: ["vibe filmmaking", "AI video", "mood-based video", "aesthetic videos", "cinematic AI"]
---
...
<FeatureGrid>
  <Feature title="Mood-Based Creation" description="Start with a feeling or atmosphere instead of a detailed script" icon="heart" />
  <Feature title="Aesthetic Matching" description="AI understands visual styles and replicates specific aesthetics" icon="palette" />
  <Feature title="Emotional Storytelling" description="Create videos that evoke specific emotions through visual language" icon="star" />
</FeatureGrid>
...
<CTABox>
  Ready to transform your vibes into videos? Get started with SuperDuperAI today!
</CTABox> 